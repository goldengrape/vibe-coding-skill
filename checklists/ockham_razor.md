# Ockham Razor Checklist

Use this after every document update.

Delete, shorten, or move content to `docs/PARKING_LOT.md` if it fails these questions:

1. Does this content help confirm intent, reduce ambiguity, define design, define an interface, define a test, or order execution?
2. Is this content referenced by a stable ID or trace link?
